	...
	return (
		<>	
		  <div className='h-[100%] w-[100%] bg-gray-400'>	
			...
			<div className= ' m-[50px] mx-[6.6%] h-[650px] w-[1650px] shadow-xl rounded-md bg-gray-300 flex flex-col items-center'>
			...
			<div className= ' m-[50px] mx-[6.6%] h-[350px] w-[1650px] shadow-xl rounded-md bg-gray-300 flex flex-col items-center'>
				<div className= 'w-[300px] border-b-2 border-black flex items-center justify-center'>
			...
			<div className='h-[90px] w-[100%] flex items-center justify-center'>			
				<Link to='/'><button className='w-[140px] p-2 text-gray-300 text-xl border-2 border-gray-300 rounded-lg hover:bg-[#362f27] hover:bg-gray-500
