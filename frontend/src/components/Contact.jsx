	...
	return (
		<>
			<div ref={contactRef} className=' font-comorant h-[500px] w-[100%] bg-orange-200 flex flex-col items-center justify-around'>
				<h1 className= 'p-7 text-4xl italic text-black border-b-2 border-black'>Contact</h1>
				<div className=' cursor-pointer text-2xl italic flex justify-center text-[#735534] p-5 transform ease-in-out duration-500 hover:text-orange-100'>lisaportergallery@hotmail.com</div>
