...
const handleMailTo = () => {
	console.log('hello');
	window.location.href = 'mailto:lisaportergallery@hotmail.com?subject=Subject&body=Body content';
};
	...
	return (
		<>
			<div ref={contactRef} className=' font-comorant h-[500px] w-[100%] bg-orange-200 flex flex-col items-center justify-around'>
				<div className= 'p-7 text-4xl italic font-light text-black border-b-2 border-black'>CONTACT</div>
				<div className=' cursor-pointer text-2xl font-light italic flex justify-center text-[#735534] p-5 transform ease-in-out duration-500 hover:text-orange-100'
				     onClick={handleMailTo}>lisaportergallery@hotmail.com</div>
