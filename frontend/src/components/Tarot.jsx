...
const invisible = 'transition-opacity ease-in-out duration-1000 delay-100 absolute top-0 left-0 opacity-0'
	...
	return (
		<>
			...
			<div className= ' m-[50px] mx-[6.6%] h-[650px] w-[1650px] shadow-xl rounded-md bg-orange-100 flex flex-col items-center'>
			...
			<div className= ' m-[50px] mx-[6.6%] h-[350px] w-[1650px] shadow-xl rounded-md bg-orange-100 flex flex-col items-center'>
				<div className= 'w-[300px] border-b-2 border-black flex items-center justify-center'>
			...
			<div className='h-[90px] w-[100%] flex items-center justify-center'>			
				<Link to='/'><button className='w-[140px] p-2 text-[#362f27] text-xl font-semibold border-2 border-orange-100 rounded-lg hover:bg-[#362f27] hover:text-orange-100 
